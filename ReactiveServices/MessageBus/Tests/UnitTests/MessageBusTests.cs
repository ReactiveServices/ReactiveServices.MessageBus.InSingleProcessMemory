...
using ReactiveServices.MessageBus.InSingleProcessMemory.Tests.Specifications;
...
namespace ReactiveServices.MessageBus.InSingleProcessMemory.Tests.UnitTests
{
    [TestFixture]
