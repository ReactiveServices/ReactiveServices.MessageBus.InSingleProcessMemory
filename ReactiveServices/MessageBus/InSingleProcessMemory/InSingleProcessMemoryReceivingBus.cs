...
{
    public class InSingleProcessMemoryReceivingBus : InSingleProcessMemoryMessageBus, IReceivingBus
    {
        public InSingleProcessMemoryReceivingBus()
        {
        ...
        private void PrepareSubscription(InSingleProcessMemorySubscription subscription)
        {
        ...
        private InSingleProcessMemorySubscription SubscriptionFor(Type messageType, SubscriptionId subscriptionId, Action<object> messageHandler, SubscriptionMode subscriptionMode)
        {
            var subscription = ExistingSubscriptionFor(messageType, subscriptionId);
        ...
        private InSingleProcessMemorySubscription NewSubscriptionFor(Type messageType, SubscriptionId subscriptionId, SubscriptionMode subscriptionMode, bool acceptMessagesOlderThanSubscriptionTime, Action<object> messageHandler)
        {
            var queueName = QueueNameFor(messageType, subscriptionId);
        ...
        protected virtual InSingleProcessMemorySubscription NewReceivingSubscription(Type messageType, SubscriptionId subscriptionId, SubscriptionMode subscriptionMode,
